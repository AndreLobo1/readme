...
| <a href="https://github.com/features/copilot" target="_blank"><img src="assets/assetsREADME/copilot.webp" width="125" height="125"> | <a href="https://gemini.google.com/" target="_blank">**Gemini**</a> Inteligência artificial do Google. Utilizada no projeto para correção de texto avançada, enriquecendo a experiência do usuário. |
| | |
...
| <a href="https://github.com/features/copilot" target="_blank"><img src="assets/assetsREADME/copilot.webp" width="125" height="125"> | <a href="https://nodejs.org/" target="_blank">**Node.js**</a> Ambiente de execução JavaScript do lado do servidor. Empregado como parte fundamental da infraestrutura do projeto, usado para criar aplicações de rede escaláveis. |
| <a href="https://www.npmjs.com/" target="_blank"><img src="assets/assetsREADME/copilot.webp" width="125" height="125"> | <a href="https://github.com/features/copilot" target="_blank">**NPM**</a> Gerenciador de pacotes para Node.js. Utilizado extensivamente no gerenciamento das dependências do projeto, facilitando o compartilhamento e reutilização de código. |
| | |
| <span id="frameworks"></span> **Ferramentas de Teste e Qualidade** | |
| <a href="https://mochajs.org/" target="_blank"><img src="assets/assetsREADME/copilot.webp" width="125" height="125"> | <a href="https://github.com/features/copilot" target="_blank">**Mocha**</a> Framework de testes para Node.js. Testado o projeto para garantir qualidade e confiabilidade, permitindo testes assíncronos e flexíveis. |
| <a href="https://sinonjs.org/" target="_blank"><img src="assets/assetsREADME/copilot.webp" width="125" height="125"> | <a href="https://github.com/features/copilot" target="_blank">**Sinon.js**</a> Sinon.js é uma biblioteca de testes. No projeto, o Sinon.js foi utilizado para criar spies, stubs e mocks, que são ferramentas para testar funções de forma isolada. Isso permite simular e verificar comportamentos específicos das funções sem a necessidade de depender de suas dependências externas, tornando os testes mais precisos e confiáveis. |
| | |
...
| <a href="https://developer.mozilla.org/pt-BR/docs/Web/JavaScript" target="_blank"><img src="assets/assetsREADME/markdown.png" width="125" height="125"> | <a href="https://www.markdownguide.org/" target="_blank">**JavaScript**</a> é uma linguagem de script versátil usada para criar interações dinâmicas em websites. No projeto, foi empregado para desenvolver tanto o frontend quanto o backend, proporcionando uma experiência de usuário interativa e funcionalidades do servidor. |
| <a href="https://pt.wikipedia.org/wiki/SQL" target="_blank"><img src="assets/assetsREADME/markdown.png" width="125" height="125"> | <a href="https://www.markdownguide.org/" target="_blank">**SQL**</a> é uma linguagem de consulta para gerenciar bancos de dados relacionais. No projeto, SQL foi utilizado para estruturar, consultar e manipular dados, assegurando a integridade e eficiência no gerenciamento das informações. |
| | |
| <span id="linguagens_marcacao"></span> **Banco de Dados e Ferramentas Relacionadas** | |
| <a href="https://dbeaver.io/" target="_blank"><img src="assets/assetsREADME/markdown.png" width="125" height="125"> | <a href="https://www.markdownguide.org/" target="_blank">**DBeaver**</a> Software universal de banco de dados. Banco de dados utilizado no projeto, com suporte para todas as bases de dados populares, para desenvolvedores e administradores. |
| <a href="https://www.postgresql.org/" target="_blank"><img src="assets/assetsREADME/markdown.png" width="125" height="125"> | <a href="https://www.markdownguide.org/" target="_blank">**PostgreSQL**</a> Sistema gerenciador de banco de dados relacional objeto. Banco de dados escolhido para operações no projeto, conhecido por sua robustez e conformidade com padrões. |
| <a href="https://render.com/" target="_blank"><img src="assets/assetsREADME/copilot.webp" width="125" height="125"> | <a href="https://github.com/features/copilot" target="_blank">**Render**</a> Serviço de hospedagem em nuvem. Usado em conjunto com o banco de dados e para o deploy do projeto, permitindo implantação automatizada e gerenciamento de aplicativos web. |
| | |
...
| <a href="https://github.com/ondras/wwwsqldesigner" target="_blank"><img src="assets/assetsREADME/canva.png" width="125" height="125"> | <a href="https://www.canva.com/" target="_blank">**SQL Designer**</a> Ferramenta visual para criação e otimização de modelos de banco de dados relacionais. Utilizado no planejamento da arquitetura de dados do projeto. |
